...
module.exports = helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "ws:", "wss:", "http://localhost:*", "ws://localhost:*", "http://127.0.0.1:*", "ws://127.0.0.1:*", "https://unpkg.com", "blob:"], 
      fontSrc: ["'self'", "data:", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com"],
      mediaSrc: ["'self'", "https://assets.mixkit.co", "https://actions.google.com", "blob:"],
      objectSrc: ["'none'"],
